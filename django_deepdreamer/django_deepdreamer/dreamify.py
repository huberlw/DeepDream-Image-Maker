...
""" MAIN LOOP HERE """
def sweet_dreams(request):
    # inputs: 0 - 4
    inputs = ['D:\Resarch Jobs\Project Clones\DeepDream-Image-Maker\django_deepdreamer\django_deepdreamer\images\cat.jpg']
    # layers: 0 - 10
    concatenated_layers = ['mixed0', 'mixed1', 'mixed2', 'mixed3', 'mixed4', 'mixed5', 'mixed6', 'mixed7', 'mixed8', 'mixed9', 'mixed10']

    # image to dreamify
    original_img = PIL.Image.open(inputs[0])
    ...
    # create output file
    saved = cv2.imwrite('D:/Resarch Jobs/Project Clones/DeepDream-Image-Maker/django_deepdreamer/django_deepdreamer/tmp_save/tmp_dreams_cat.png', np.array(img))
